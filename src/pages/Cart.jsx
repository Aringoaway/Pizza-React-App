...
import {clearCart, removeCartItem, minusCartItem, plusCartItem} from "../redux/action/cart";
						...
						<div className="cart">
							...
							<div className="cart__bottom">
								<div className="cart__bottom-details">
									<span> Total pizzas: <b>{totalCount} piece.</b> </span>
									<span> Order amount: <b>{totalPrice} Kč</b> </span>
								</div>
